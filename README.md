...
Milestone 7 complete: six editable templates (Blank, Algorithm / LeetCode, System Architecture, User Flow, Project Planning, Concept Map), each verified for creation, reopening, and subsequent editing. Populated templates fit the initial viewport; later visits restore the saved viewport.
